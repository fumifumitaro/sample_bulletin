 ...
 * @return bool
 */
function createTableForBBS(PDO $pdo, $TABLE_NAME)
{
    try {
 ...
 * @return string
 */
function post(PDO $pdo, $TABLE_NAME, $name, $password, $comment)
{
 ...
 * @return void
 */
function preEdit(PDO $pdo, $TABLE_NAME, $id, $password)
{
    //指定idの書き込みを取得
 ...
 * @return string
 */
function deletePost(PDO $pdo, $TABLE_NAME, $id, $password)
{
    //パスワードが一致するか確かめる
